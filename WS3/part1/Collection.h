...
namespace sdds {
	...
	template<typename T, unsigned C=100> // C-capacity
	class Collection {
		T m_items[C]{}; 
		...
		void setSmallestItem(const T& obj); // updates m_smallestItem 
		void setLargestItem(const T& obj); // updates m_largestItem
	public:
