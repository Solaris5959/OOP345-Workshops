...
namespace sdds {
    ...
    Book::Book(const Book& copyBook) {
        ...
        titleBook = copyBook.titleBook;
        countryPublished = copyBook.countryPublished;
        yearPublished = copyBook.yearPublished;
        salePrice = copyBook.salePrice;
    ...
    std::ostream &operator<< (std::ostream &os, const Book &book) {
        os << std::setw(20) << book.author << " | " << std::setw(22) << book.titleBook << " | " 
            ...
            << std::setw(6) << std::fixed << std::setprecision(2) << book.salePrice << " | " << book.description << std::endl;
